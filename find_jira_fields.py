...
def main():
    ...
    print("  4. Paste the FIELD KEY into config.py → INSTANCE_FIELDS")
    print()
    print("  SPACES REMINDER:")
    print("  ✅  customfield_10042          → correct — use this in config.py")
    print("  ❌  'Prod Instances Done'      → display name — do NOT use in config.py")
    print("  ✅  'In Progress' as a VALUE   → fine, spaces OK in values/options")
    print("=" * 80 + "\n")
